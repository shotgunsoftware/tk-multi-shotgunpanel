...
class SgTaskModel(ShotgunOverlayModel):
    ...
    def load_data(self, entity_link):
        """
        """
        fields = ["content", "task_assignees", "step", "sg_status_list", "start_date", "due_date"]
        filters = [["entity", "is", entity_link]]
    ...
    def _populate_thumbnail(self, item, field, path):
        ...
        # todo - reach out to user model and 
