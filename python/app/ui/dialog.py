...
"")
        ...
        self.gridLayout.addWidget(self.publish_thumb, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.publish_text, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.publish_actions_btn, 0, 2, 1, 1)
        self.publish_lower_text = QtGui.QLabel(self.publish_details)
        self.publish_lower_text.setObjectName("publish_lower_text")
        self.gridLayout.addWidget(self.publish_lower_text, 1, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.version_thumb, 0, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.version_text, 0, 1, 1, 1)
        ...
        self.version_lower_text = QtGui.QLabel(self.version_details)
        self.version_lower_text.setWordWrap(True)
        self.version_lower_text.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByKeyboard|QtCore.Qt.LinksAccessibleByMouse)
        self.version_lower_text.setObjectName("version_lower_text")
        self.gridLayout_2.addWidget(self.version_lower_text, 1, 0, 1, 2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.publish_lower_text.setText(QtGui.QApplication.translate("Dialog", "TextLabel", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.version_lower_text.setText(QtGui.QApplication.translate("Dialog", "Description and version info", None, QtGui.QApplication.UnicodeUTF8))
