...
"")
        ...
        self.checkBox = QtGui.QCheckBox(self.entity_version_tab)
        ...
        self.version_note_input.setMinimumSize(QtCore.QSize(0, 40))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.checkBox.setText(QtGui.QApplication.translate("Dialog", "Only show versions pending review", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.publish_tab_widget.setTabText(self.publish_tab_widget.indexOf(self.tab), QtGui.QApplication.translate("Dialog", "Uses", None, QtGui.QApplication.UnicodeUTF8))
        self.publish_tab_widget.setTabText(self.publish_tab_widget.indexOf(self.tab_2), QtGui.QApplication.translate("Dialog", "Used By", None, QtGui.QApplication.UnicodeUTF8))
