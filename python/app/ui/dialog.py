...
"")
        ...
        self.details_thumb.setMinimumSize(QtCore.QSize(128, 100))
        self.details_thumb.setMaximumSize(QtCore.QSize(128, 100))
        ...
        self.current_user_icon = QtGui.QLabel(self.entity_note_tab)
        self.current_user_icon.setMinimumSize(QtCore.QSize(65, 65))
        self.current_user_icon.setMaximumSize(QtCore.QSize(65, 65))
        self.current_user_icon.setText("")
        self.current_user_icon.setPixmap(QtGui.QPixmap(":/tk_multi_infopanel/default_user.png"))
        self.current_user_icon.setScaledContents(True)
        self.current_user_icon.setObjectName("current_user_icon")
        self.horizontalLayout_8.addWidget(self.current_user_icon)
        ...
        self.current_user_icon_2 = QtGui.QLabel(self.version_note_tab)
        self.current_user_icon_2.setMinimumSize(QtCore.QSize(60, 60))
        self.current_user_icon_2.setMaximumSize(QtCore.QSize(60, 60))
        self.current_user_icon_2.setText("")
        self.current_user_icon_2.setPixmap(QtGui.QPixmap(":/tk_multi_infopanel/default_user.png"))
        self.current_user_icon_2.setScaledContents(True)
        self.current_user_icon_2.setObjectName("current_user_icon_2")
        self.horizontalLayout_11.addWidget(self.current_user_icon_2)
