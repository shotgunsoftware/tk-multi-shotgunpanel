...
"")
        ...
        self.entity_actions_btn.setMinimumSize(QtCore.QSize(55, 0))
        self.entity_actions_btn.setMaximumSize(QtCore.QSize(55, 16777215))
        self.entity_actions_btn.setPopupMode(QtGui.QToolButton.InstantPopup)
        self.entity_actions_btn.setToolButtonStyle(QtCore.Qt.ToolButtonTextOnly)
        ...
        self.publish_actions_btn.setMinimumSize(QtCore.QSize(55, 0))
        self.publish_actions_btn.setMaximumSize(QtCore.QSize(55, 16777215))
        self.publish_actions_btn.setPopupMode(QtGui.QToolButton.InstantPopup)
        self.publish_actions_btn.setToolButtonStyle(QtCore.Qt.ToolButtonTextOnly)
        ...
        self.publish_publish_view_3 = QtGui.QListView(self.tab_3)
        self.publish_publish_view_3.setVerticalScrollMode(QtGui.QAbstractItemView.ScrollPerPixel)
        self.publish_publish_view_3.setHorizontalScrollMode(QtGui.QAbstractItemView.ScrollPerPixel)
        self.publish_publish_view_3.setUniformItemSizes(True)
        self.publish_publish_view_3.setObjectName("publish_publish_view_3")
        self.verticalLayout_15.addWidget(self.publish_publish_view_3)
        self.tabWidget_3.addTab(self.tab_3, "")
        self.tab = QtGui.QWidget()
        self.tab.setObjectName("tab")
        self.verticalLayout_13 = QtGui.QVBoxLayout(self.tab)
        self.verticalLayout_13.setObjectName("verticalLayout_13")
        self.publish_publish_view = QtGui.QListView(self.tab)
        ...
        self.verticalLayout_13.addWidget(self.publish_publish_view)
        self.tabWidget_3.addTab(self.tab, "")
        self.tab_2 = QtGui.QWidget()
        self.tab_2.setObjectName("tab_2")
        self.verticalLayout_14 = QtGui.QVBoxLayout(self.tab_2)
        self.verticalLayout_14.setObjectName("verticalLayout_14")
        self.publish_publish_view_2 = QtGui.QListView(self.tab_2)
        self.publish_publish_view_2.setVerticalScrollMode(QtGui.QAbstractItemView.ScrollPerPixel)
        self.publish_publish_view_2.setHorizontalScrollMode(QtGui.QAbstractItemView.ScrollPerPixel)
        self.publish_publish_view_2.setUniformItemSizes(True)
        self.publish_publish_view_2.setObjectName("publish_publish_view_2")
        self.verticalLayout_14.addWidget(self.publish_publish_view_2)
        ...
        self.version_thumb.setMinimumSize(QtCore.QSize(128, 100))
        self.version_thumb.setMaximumSize(QtCore.QSize(128, 100))
        ...
        self.version_actions_btn.setMinimumSize(QtCore.QSize(55, 0))
        self.version_actions_btn.setMaximumSize(QtCore.QSize(55, 16777215))
        self.version_actions_btn.setPopupMode(QtGui.QToolButton.InstantPopup)
        self.version_actions_btn.setToolButtonStyle(QtCore.Qt.ToolButtonTextOnly)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.entity_actions_btn.setText(QtGui.QApplication.translate("Dialog", "Actions", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.publish_actions_btn.setText(QtGui.QApplication.translate("Dialog", "Actions", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.version_actions_btn.setText(QtGui.QApplication.translate("Dialog", "Actions", None, QtGui.QApplication.UnicodeUTF8))
