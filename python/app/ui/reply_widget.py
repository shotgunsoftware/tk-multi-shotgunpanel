...
class Ui_ReplyWidget(object):
    def setupUi(self, ReplyWidget):
        ...
        self.body_label_4 = QtGui.QLabel(ReplyWidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.body_label_4.sizePolicy().hasHeightForWidth())
        self.body_label_4.setSizePolicy(sizePolicy)
        self.body_label_4.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.body_label_4.setWordWrap(True)
        self.body_label_4.setObjectName("body_label_4")
        self.verticalLayout.addWidget(self.body_label_4)
        ...
        self.thumbnail_7.setPixmap(QtGui.QPixmap(":/tk_multi_infopanel/rect_512x400.png"))
        ...
        self.thumbnail_5.setPixmap(QtGui.QPixmap(":/tk_multi_infopanel/rect_512x400.png"))
        ...
        self.thumbnail_6.setPixmap(QtGui.QPixmap(":/tk_multi_infopanel/rect_512x400.png"))
        ...
        spacerItem2 = QtGui.QSpacerItem(20, 418, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, ReplyWidget):
        ...
        self.body_label_4.setText(QtGui.QApplication.translate("ReplyWidget", "Attachments", None, QtGui.QApplication.UnicodeUTF8))
